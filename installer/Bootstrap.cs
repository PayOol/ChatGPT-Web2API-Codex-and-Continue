...
internal static class Bootstrap {
    ...
    static int Main(string[] args) {
        ...
        try {
            ...
            Console.WriteLine("Preparation de l'installateur 0.4.7 - verification de l'archive embarquee...");
            string folder = extract ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Web2API-Continue-Setup", "0.4.7-" + Guid.NewGuid().ToString("N"));
